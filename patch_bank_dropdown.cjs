...
const replacement = `{form.paymentMode !== 'Cash' && (
                <div>
...
code = code.substring(0, startIndex) + replacement + code.substring(endIndex + targetEndString.length);
